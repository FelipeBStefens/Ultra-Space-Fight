...
public class FreighterShipDAO implements CrudInterface<FreighterShip> {
    ...
    private final String SQL_READ = """
        SELECT * FROM freighter_ship WHERE id_ship = ?;    
        """;

    private final String SQL_READ_ALL = """
        SELECT * FROM freighter_ship;    
        """;
    ...
    public FreighterShip read(long id) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                freighterShip = new FreighterShip(resultSet.getInt("life"), resultSet.getInt("speed"), resultSet.getInt("damage"),
    ...
    public List<FreighterShip> readAll() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                FreighterShip freighterShip = new FreighterShip(resultSet.getInt("life"), resultSet.getInt("speed"), resultSet.getInt("damage"),
                userDAO.read(resultSet.getLong("id_user")));
                freighterShip.setIdShip(resultSet.getLong("id_ship"));
